...
import ru.ifsoft.network.DoubleClickListener;
...
public class AdvancedItemListAdapter extends RecyclerView.Adapter<AdvancedItemListAdapter.ViewHolder> implements Constants, TagClick {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView mItemMenuButton;// mLikeAnimImage, mLikeAnimImage2;
        public LottieAnimationView likeAnim,likeAnim2;
...
//                mLikeAnimImage =(ImageView) v.findViewById(R.id.like_anim_image);
//                mLikeAnimImage2 =(ImageView) v.findViewById(R.id.like_anim_image2);
                likeAnim = v.findViewById(R.id.like_anim);
                likeAnim2 = v.findViewById(R.id.like_anim2);
...
//                    holder.mLikeAnimImage.setVisibility(View.INVISIBLE);
//                    holder.mLikeAnimImage2.setVisibility(View.INVISIBLE);
                    ...
                    p.setLikesCount(p.getLikesCount() + 1);
                      ...
                      holder.likeAnim2.setVisibility(View.VISIBLE);
//                    Animation likeStart = AnimationUtils.loadAnimation(context,R.anim.like_anim);
//                    holder.mLikeAnimImage.setVisibility(View.VISIBLE);
//                    holder.mLikeAnimImage2.setVisibility(View.VISIBLE);
                    Log.e(TAG, "onDoubleClick: "+" image set to visible!!!!!!!!!!!!!!!!!" );
...
//                            holder.mLikeAnimImage.setVisibility(View.INVISIBLE);
//                            holder.mLikeAnimImage2.setVisibility(View.INVISIBLE);
                            holder.likeAnim.setVisibility(View.INVISIBLE);
                            holder.likeAnim2.setVisibility(View.INVISIBLE);
                            Log.e(TAG, "onDoubleClick: "+" image set to in---visible!!!!!!!!!!!!!!!!!" );

                        }
                    }, 1300);

//                    holder.mLikeAnimImage.startAnimation(likeStart);
//                    holder.mLikeAnimImage2.startAnimation(likeStart);
