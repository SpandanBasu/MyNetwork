...
public interface Constants {
    ...
    public static final int VIDEO_FILE_MAX_SIZE = 104857600; //Max size for video file in bytes | For example 7mb = 7*1024*1024

    // Your API KEY for playing youtube video in app | See here: http://ifsoft.co.uk/help/how_to_using_youtube_video_in_android_app/

    public static final String YOUTUBE_API_KEY = "AIzaSyAz8TvzJ345tYkvsdfgNNRsQzdfg2T9atmQZOyc3OTk";
    ...
    public static final String BILLING_KEY = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAn6iTaSxTJhwjspvU2am8rrikr";

    public static final String WEB_SITE = "https://indivocals.com/";  //web site url address

    // Client ID For identify the application | Must be the same with CLIENT_ID from server config: db.inc.php

    public static final String CLIENT_ID = "87390";  // Correct example: 12567 | Incorrect example: 0987
    ...
    public static final String API_DOMAIN = "https://indivocals.com/";  // url address to which the application sends requests || http://10.0.2.2/ - for test on emulator in localhost [XAMPP]
